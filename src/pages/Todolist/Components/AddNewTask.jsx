...
export default function AddNewTask({ postFunc, theme }) {
  ...
  const validateForm = () => {
    ...
    if (inputData.priority && (isNaN(inputData.priority) || inputData.priority < 0 || inputData.priority > 5)) {
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <Box sx={{ 
            ...
            <div style={{ 
              ...
              💡 <strong>Tips:</strong> Use Ctrl+Enter to quick submit • Priority: 0-2 (Low), 2-4 (Medium), 4-5 (High)
            </div>
          </Box>
        </div>
      </Box>
